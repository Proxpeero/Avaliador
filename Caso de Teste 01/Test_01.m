...
%%  Módulo 01 - Trajetória Helicoidal

% r = 1; % raio da hélice
% h = 20; % altura da hélice
% omega = 0.2*pi; % velocidade angular (rad/s)
% n_turns = 10; % número de voltas da hélice
...
k_p = 3.5; % ganho proporcional do filtro Mahony
k_i = 0.003; % ganho integral do filtro Mahony
